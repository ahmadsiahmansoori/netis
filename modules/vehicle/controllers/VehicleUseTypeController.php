...
use app\modules\vehicle\models\searchModels\VehicleUseTypeSearchModel;
use app\modules\vehicle\models\VehicleUseType;
use yii\data\ActiveDataProvider;
use yii\rest\ActiveController;
use yii\web\Response as webResponse;

class VehicleUseTypeController extends ActiveController
{
...
//    ];
    ...
    {
        $model = new VehicleUseTypeSearchModel();
    ...
    public $modelClass = VehicleUseType::class;
