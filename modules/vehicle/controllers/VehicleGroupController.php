...
use app\modules\vehicle\models\searchModels\VehicleGroupSearchModel;
...
class VehicleGroupController extends ActiveController
{
...
//    ];
    ...
    public function prepareDataProvider(): ActiveDataProvider
    {
        ...
        $model = new VehicleGroupSearchModel();
        $model->attributes = \Yii::$app->request->queryParams;
        return  $model->search();

    }

    public $modelClass = VehicleGroup::class;
