...
/**
 * This is the model class for table "additional_cov".
 *
 ...
 */
class AdditionalCov extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public static function insertFan()
    {
        ...
        if ($data['status'])
        {
            ...
            try {
                foreach ($data as $kay ) {
                    $model = AdditionalCov::findOne(['id' => $kay['id']]);
                    if (empty($model))
                    {
                        $model = new AdditionalCov();
                    }
