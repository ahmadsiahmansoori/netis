...
/**
 * This is the model class for table "insurance_corp".
 *
 * @property int $id
 * @property string|null $name
 * @property int|null $active
 */
class InsuranceCorp extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public static function insertFan()
    {
        ...
        if ($data['status'])
        {
            ...
            try {
                foreach ($data as $kay ) {
                    $model = InsuranceCorp::findOne(['id' => $kay['id']]);
                    if (empty($model))
                    {
                        $model = new InsuranceCorp();
                    }
